  ...
  return (
    <div
      ...
      style={{
        ...
        // No synthesized white stroke — the art's own dark contour carries the
        // silhouette on both light and dark, and any halo left faint white
        // pixels around the edge. (History has the drop-shadow version if we
        // ever want it back.)
